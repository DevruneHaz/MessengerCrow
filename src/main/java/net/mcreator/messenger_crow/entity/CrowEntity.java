...
package net.mcreator.messenger_crow.entity;
...
import net.mcreator.messenger_crow.procedures.CrowTickUpdateProcedure;
import net.mcreator.messenger_crow.procedures.CrowStruckByLightingProcedure;
import net.mcreator.messenger_crow.procedures.CrowRightClickedProcedure;
import net.mcreator.messenger_crow.procedures.CrowOnSpawnProcedure;
...
public class CrowEntity extends TamableAnimal implements GeoEntity {
	...
	public void thunderHit(ServerLevel serverWorld, LightningBolt lightningBolt) {
		...
		CrowStruckByLightingProcedure.execute(this);
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		CrowOnSpawnProcedure.execute(world, this);
		return retval;
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		CrowRightClickedProcedure.execute(world, entity, sourceentity);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		CrowTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
