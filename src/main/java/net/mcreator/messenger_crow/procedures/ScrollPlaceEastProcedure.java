...
public class ScrollPlaceEastProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Direction direction, Entity entity, double hitY, double hitZ) {
		...
		if (!world.isClientSide()) {
			if (direction == Direction.EAST) {
				if (hitZ > z + 0.75 && hitZ <= z + 0.9375 && hitY > y + 0.5625 && hitY <= y + 0.75) {
					if (!world.isClientSide()) {
				...
				} else if (hitZ > z + 0.4375 && hitZ <= z + 0.6875 && hitY > y + 0.5625 && hitY <= y + 0.8125) {
					if (!world.isClientSide()) {
						BlockPos _bp = BlockPos.containing(x, y, z);
						BlockEntity _blockEntity = world.getBlockEntity(_bp);
						BlockState _bs = world.getBlockState(_bp);
					...
					AddRemoveScrollProcedure.execute(world, x, y, z, entity);
				} else if (hitZ > z + 0.0625 && hitZ <= z + 0.375 && hitY > y + 0.5625 && hitY <= y + 0.875) {
					if (!world.isClientSide()) {
						BlockPos _bp = BlockPos.containing(x, y, z);
						BlockEntity _blockEntity = world.getBlockEntity(_bp);
						BlockState _bs = world.getBlockState(_bp);
					...
					AddRemoveScrollProcedure.execute(world, x, y, z, entity);
				} else if (hitZ > z + 0.625 && hitZ <= z + 0.9375 && hitY > y + 0.0625 && hitY <= y + 0.375) {
					if (!world.isClientSide()) {
						BlockPos _bp = BlockPos.containing(x, y, z);
						BlockEntity _blockEntity = world.getBlockEntity(_bp);
						BlockState _bs = world.getBlockState(_bp);
					...
					AddRemoveScrollProcedure.execute(world, x, y, z, entity);
				} else if (hitZ > z + 0.3125 && hitZ <= z + 0.5625 && hitY > y + 0.0625 && hitY <= y + 0.3125) {
					if (!world.isClientSide()) {
						BlockPos _bp = BlockPos.containing(x, y, z);
						BlockEntity _blockEntity = world.getBlockEntity(_bp);
						BlockState _bs = world.getBlockState(_bp);
					...
					AddRemoveScrollProcedure.execute(world, x, y, z, entity);
				} else if (hitZ > z + 0.0625 && hitZ <= z + 0.25 && hitY > y + 0.0625 && hitY <= y + 0.25) {
					if (!world.isClientSide()) {
						BlockPos _bp = BlockPos.containing(x, y, z);
						BlockEntity _blockEntity = world.getBlockEntity(_bp);
						BlockState _bs = world.getBlockState(_bp);
