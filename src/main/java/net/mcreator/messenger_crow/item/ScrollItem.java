...
import net.mcreator.messenger_crow.procedures.ScrollTickUpdateProcedure;
import net.mcreator.messenger_crow.procedures.ScrollRightClickedProcedure;
import net.mcreator.messenger_crow.item.inventory.ScrollInventoryCapability;
...
public class ScrollItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		ScrollRightClickedProcedure.execute(entity, ar.getObject());
		return ar;
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		ScrollTickUpdateProcedure.execute(itemstack);
	}
