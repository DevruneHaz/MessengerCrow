...
import net.mcreator.messenger_crow.network.ScrollLecternGUIButtonMessage;
...
public class ScrollLecternGUIScreen extends AbstractContainerScreen<ScrollLecternGUIMenu> {
	...
	public ScrollLecternGUIScreen(ScrollLecternGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("messenger_crow:textures/screens/scroll_lectern_gui.png");
