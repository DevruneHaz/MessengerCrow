...
public class ScrollGUIScreen extends AbstractContainerScreen<ScrollGUIMenu> implements WidgetScreen {
	...
	private static final ResourceLocation texture = new ResourceLocation("messenger_crow:textures/screens/scroll_gui.png");
	...
	public void containerTick() {
		super.containerTick();
		MessengerCrowMod.PACKET_HANDLER.sendToServer(new ScrollGUIMenu.ScrollGUIOtherMessage(0, x, y, z, textstate));
		ScrollGUIMenu.ScrollGUIOtherMessage.handleOtherAction(entity, 0, x, y, z, textstate);
	}
