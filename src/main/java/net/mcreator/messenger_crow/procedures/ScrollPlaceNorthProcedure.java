...
public class ScrollPlaceNorthProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Direction direction, Entity entity, double hitX, double hitY) {
		...
		if (!world.isClientSide()) {
			if (direction == Direction.NORTH) {
				if (hitX > x + 0.75 && hitX <= x + 0.9375 && hitY > y + 0.5625 && hitY <= y + 0.75) {
					if (!world.isClientSide()) {
				...
				} else if (hitX > x + 0.4375 && hitX <= x + 0.6875 && hitY > y + 0.5625 && hitY <= y + 0.8125) {
					if (!world.isClientSide()) {
						BlockPos _bp = BlockPos.containing(x, y, z);
						BlockEntity _blockEntity = world.getBlockEntity(_bp);
						BlockState _bs = world.getBlockState(_bp);
					...
					AddRemoveScrollProcedure.execute(world, x, y, z, entity);
				} else if (hitX > x + 0.0625 && hitX <= x + 0.375 && hitY > y + 0.5625 && hitY <= y + 0.875) {
					if (!world.isClientSide()) {
						BlockPos _bp = BlockPos.containing(x, y, z);
						BlockEntity _blockEntity = world.getBlockEntity(_bp);
						BlockState _bs = world.getBlockState(_bp);
					...
					AddRemoveScrollProcedure.execute(world, x, y, z, entity);
				} else if (hitX > x + 0.625 && hitX <= x + 0.9375 && hitY > y + 0.0625 && hitY <= y + 0.375) {
					if (!world.isClientSide()) {
						BlockPos _bp = BlockPos.containing(x, y, z);
						BlockEntity _blockEntity = world.getBlockEntity(_bp);
						BlockState _bs = world.getBlockState(_bp);
					...
					AddRemoveScrollProcedure.execute(world, x, y, z, entity);
				} else if (hitX > x + 0.3125 && hitX <= x + 0.5625 && hitY > y + 0.0625 && hitY <= y + 0.3125) {
					if (!world.isClientSide()) {
						BlockPos _bp = BlockPos.containing(x, y, z);
						BlockEntity _blockEntity = world.getBlockEntity(_bp);
						BlockState _bs = world.getBlockState(_bp);
					...
					AddRemoveScrollProcedure.execute(world, x, y, z, entity);
				} else if (hitX > x + 0.0625 && hitX <= x + 0.25 && hitY > y + 0.0625 && hitY <= y + 0.25) {
					if (!world.isClientSide()) {
						BlockPos _bp = BlockPos.containing(x, y, z);
						BlockEntity _blockEntity = world.getBlockEntity(_bp);
						BlockState _bs = world.getBlockState(_bp);
