...
public class AddRemoveScrollProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (new Object() {
		...
		}.getAmount(world, BlockPos.containing(x, y, z), (int) (new Object() {
		...
		}.getValue(world, BlockPos.containing(x, y, z), "slotNum"))) > 0) {
			if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == ItemStack.EMPTY.getItem()) {
				if (entity instanceof LivingEntity _entity) {
					...
					}.getValue(world, BlockPos.containing(x, y, z), "slotNum")))).copy();
				...
				}
				{
					...
					if (_ent != null) {
						...
						}.getValue(world, BlockPos.containing(x, y, z), "slotNum"));
				...
				}
				{
					...
					}.getValue(world, BlockPos.containing(x, y, z), "scrollNum"))) instanceof BooleanProperty _booleanProp)
