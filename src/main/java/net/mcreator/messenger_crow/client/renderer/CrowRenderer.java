...
package net.mcreator.messenger_crow.client.renderer;
...
import net.mcreator.messenger_crow.entity.model.CrowModel;
import net.mcreator.messenger_crow.entity.layer.CrowLayer;
...
public class CrowRenderer extends GeoEntityRenderer<CrowEntity> {
	public CrowRenderer(EntityRendererProvider.Context renderManager) {
		...
		this.addRenderLayer(new CrowLayer(this));
	}
