...
import net.mcreator.messenger_crow.network.RedScrollLecternGUIButtonMessage;
...
public class RedScrollLecternGUIScreen extends AbstractContainerScreen<RedScrollLecternGUIMenu> {
	private final static HashMap<String, Object> guistate = RedScrollLecternGUIMenu.guistate;
	...
	public RedScrollLecternGUIScreen(RedScrollLecternGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("messenger_crow:textures/screens/red_scroll_lectern_gui.png");
	...
	public void init() {
		super.init();
		Username = new EditBox(this.font, this.leftPos + 59, this.topPos + 10, 88, 18, Component.translatable("gui.messenger_crow.red_scroll_lectern_gui.Username")) {
			@Override
			public void insertText(String text) {
				super.insertText(text);
				if (getValue().isEmpty())
					setSuggestion(Component.translatable("gui.messenger_crow.red_scroll_lectern_gui.Username").getString());
				else
					setSuggestion(null);
			}
		...
		Username.setSuggestion(Component.translatable("gui.messenger_crow.red_scroll_lectern_gui.Username").getString());
		Username.setMaxLength(16);
		Username.setBordered(false);
		Username.setTextColor(15221304);
		...
		button_empty = new PlainTextButton(this.leftPos + 5, this.topPos + 4, 25, 20, Component.translatable("gui.messenger_crow.red_scroll_lectern_gui.button_empty"), e -> {
			if (true) {
				...
				MessengerCrowMod.PACKET_HANDLER.sendToServer(new RedScrollLecternGUIButtonMessage(0, x, y, z, textstate));
				RedScrollLecternGUIButtonMessage.handleButtonAction(entity, 0, x, y, z, textstate);
			}
		}, this.font);
		guistate.put("button:button_empty", button_empty);
		this.addRenderableWidget(button_empty);
		button_empty1 = new PlainTextButton(this.leftPos + 148, this.topPos + 3, 25, 20, Component.translatable("gui.messenger_crow.red_scroll_lectern_gui.button_empty1"), e -> {
			if (true) {
				textstate.put("textin:Username", Username.getValue());
				textstate.put("textin:Line1", Line1.getValue());
				textstate.put("textin:Line2", Line2.getValue());
				textstate.put("textin:Line3", Line3.getValue());
				MessengerCrowMod.PACKET_HANDLER.sendToServer(new RedScrollLecternGUIButtonMessage(1, x, y, z, textstate));
				RedScrollLecternGUIButtonMessage.handleButtonAction(entity, 1, x, y, z, textstate);
			}
		}, this.font);
