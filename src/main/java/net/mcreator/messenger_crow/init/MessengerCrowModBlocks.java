...
import net.mcreator.messenger_crow.block.ScrollShelfBlock;
...
public class MessengerCrowModBlocks {
	...
	public static final RegistryObject<Block> SCROLL_SHELF = REGISTRY.register("scroll_shelf", () -> new ScrollShelfBlock());
