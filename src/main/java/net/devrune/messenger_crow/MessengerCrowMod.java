...
import net.devrune.messenger_crow.init.MessengerCrowModTabs;
import net.devrune.messenger_crow.init.MessengerCrowModSounds;
...
public class MessengerCrowMod {
						...
						for (Field field : fields) {
							if (EditBox.class.isAssignableFrom(field.getType())) {
								try {
									...
									MessengerCrowMod.LOGGER.error(exceptionAsString);
								}
							}
						}
					}
	...
	public static class initer {
		...
		public static void init(FMLCommonSetupEvent event) {
			MessengerCrowMod.addNetworkMessage(TextboxSetMessage.class, TextboxSetMessage::buffer, TextboxSetMessage::new, TextboxSetMessage::handler);
		}
	}
